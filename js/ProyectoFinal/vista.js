function all() {
    $.ajax({
        url: 'http://localhost:9000/electiva2/api/vista', // Reemplaza con la URL de tu API
        method: 'GET',
...
function findById(id){
    $.ajax({
        url: 'http://localhost:9000/electiva2/api/vista/'+id, // Reemplaza con la URL de tu API
        method: 'GET',
        success: function(data) {
            $("#id").val(data.id);
...
function update(){
    ...
    // Enviar datos al servidor mediante AJAX
    $.ajax({
        url: 'http://localhost:9000/electiva2/api/vista/'+$("#id").val(), // Reemplaza con la URL de tu API
